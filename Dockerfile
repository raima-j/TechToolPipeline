...
WORKDIR /app/TechnicalTools

# Copy the entire project (including assets folder) into the container
COPY . /app/TechnicalTools/

# Install the Python dependencies from requirements.txt
RUN pip install --no-cache-dir -r requirements.txt

# Set environment variables for Tesseract and Poppler paths inside the container
ENV TESSDATA_PREFIX="/app/TechnicalTools/Assets/Tesseract-OCR/"
ENV POPPLER_PATH="/app/TechnicalTools/Assets/Release-24.02.0-0/poppler-24.02.0/Library/bin/"
...
CMD [ "python", "./PDFConverter/app.py" ]
